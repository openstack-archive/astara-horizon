...
class TenantsTable(tables.DataTable):
    name = tables.Column('name', verbose_name=_('Name'), link="horizon:admin:rugtenants:tenant")
...
class RouterRebuildAction(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        return reverse("horizon:admin:rugtenants:rebuild", kwargs={'tenant_id': datum.tenant_id,
                                                                   'router_id': datum.id})
...
class TenantRouterTable(tables.DataTable):
    ...
    class Meta:
        ...
        row_actions = (RouterRebuildAction, RouterUpdateAction, RouterManageAction, RouterDebugAction, )